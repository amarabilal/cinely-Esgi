...
<template>
  <PublicLayout>
    <article class="prose prose-zinc dark:prose-invert mx-auto max-w-3xl px-6 py-12">
      ...
      <p>Notes App est une application web de prise de notes permettant de créer, organiser, partager et collaborer sur des notes de manière sécurisée. Le Service est accessible via navigateur web.</p>

      <h2>3. Accès au Service</h2>
      <p>L'accès au Service nécessite la création d'un compte utilisateur avec une adresse email valide et un mot de passe. Vous êtes responsable de la confidentialité de vos identifiants.</p>
      ...
      <p>Le Service est fourni « en l'état ». Nous ne garantissons pas une disponibilité continue et ne saurions être tenus responsables en cas de perte de données ou d'indisponibilité.</p>
